...
from .models import Notebook, Smartphone, Television, Category, LatestProducts, Customer, Cart, CartProduct
...
class BaseView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        products = LatestProducts.objects.get_products_for_main_page(
            'notebook', 'smartphone', 'television', with_respect_to='television'
        )
        context = {
...
class AddToCartView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        cart_product, created = CartProduct.objects.get_or_create(
            user=self.cart.owner, cart=self.cart, content_type=content_type, obj_id=product.id
        )
        if created:
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Спасибо за заказ менджер скоро с Вами свяжется')
